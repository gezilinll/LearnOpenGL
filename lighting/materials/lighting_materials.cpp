...
int main() {
    ...
    //构建被光照与灯着色器程序
    Shader lightingShader("lighting/materials/lighting_vertex_materials.glsl",
                          "lighting/materials/lighting_fragment_materials.glsl");
    Shader lampShader("lighting/materials/lighting_vertex_materials_lamp.glsl",
                      "lighting/materials/lighting_fragment_materials_lamp.glsl");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glm::vec3 diffuseColor = lightColor   * glm::vec3(0.5f); // 降低比例
        glm::vec3 ambientColor = diffuseColor * glm::vec3(0.2f); // 低比例
        ...
        lightingShader.setVec3("material.specular", 0.5f, 0.5f, 0.5f); //镜面光不会百分百影响这个物体的材质
 ...
 * 要想纠正这一问题，你需要将所有的光照强度都设置为vec3(1.0)，这样才能得到正确的输出：
 * https://learnopengl.com/code_viewer_gh.php?code=src/2.lighting/3.2.materials_exercise1/materials_exercise1.cpp，我做的是青色塑料(Cyan Plastic)的箱子。
 * */