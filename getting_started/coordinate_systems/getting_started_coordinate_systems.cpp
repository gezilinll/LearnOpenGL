...
int main() {
    ...
    //构建着色器程序
    Shader ourShader("getting_started/coordinate_systems/getting_started_vertex_coordinate_systems.glsl",
                     "getting_started/coordinate_systems/getting_started_fragment_coordinate_systems.glsl");
